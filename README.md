...
```js
import { request } from '@eyewa/graphql-request'
...
```js
import { request, GraphQLClient } from '@eyewa/graphql-request'
...
```js
import { GraphQLClient } from '@eyewa/graphql-request'
...
```js
const { request } = require('@eyewa/graphql-request')
...
```js
import { rawRequest } from '@eyewa/graphql-request'
